...
| Core tests | `macos-14` | `DriveLayerCore` compiles and its **251 tests across 34 suites** pass |
...
swift test          # 251 tests, 34 suites
...
Tests/DriveLayerCoreTests/ 251 tests, weighted towards failure cases
