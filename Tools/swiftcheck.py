...
CBCharacteristicProperties CBMutableCharacteristic
...
CPVoiceControlTemplate CPVoiceControlState
...
MapKit MKDirections MKMapItem MKPlacemark MKPolyline MKLocalSearch MKError
MKCoordinateRegion CLLocationCoordinate2D Request Response NSRange NSError
NSURLErrorDomain
...
UserNotifications UNAuthorizationStatus UNNotificationPresentationOptions UNNotificationResponse
UNUserNotificationCenterDelegate UNNotificationCategory UNNotificationAction
